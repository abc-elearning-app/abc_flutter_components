...
class BookAnimationIcon extends StatelessWidget {
  final Color color;
  final double? size;

  const BookAnimationIcon(
      {super.key, this.color = Colors.white, this.size = 24});
  ...
  Widget build(BuildContext context) {
    return SvgPicture.string(getIconContent(getHexCssColor(color)),
