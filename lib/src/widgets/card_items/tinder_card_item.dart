...
class TinderCardItem extends StatefulWidget {
  ...
  @override
  State<TinderCardItem> createState() => _TinderCardItemState();
...
class _TinderCardItemState extends State<TinderCardItem>
  ...
  @override
  void didUpdateWidget(covariant TinderCardItem oldWidget) {
...
class CardAnimation {
  static Animation<Alignment> frontCardAlign(
    ...
    if (_TinderCardItemState._trigger == TriggerDirection.none) {
      endX = beginAlign.x > 0
    ...
    } else if (_TinderCardItemState._trigger == TriggerDirection.left) {
      endX = beginAlign.x - swipeEdge;
      endY = beginAlign.y + 0.5;
    }
    /* Trigger Swipe Up or Down */
    else if (_TinderCardItemState._trigger == TriggerDirection.up ||
        _TinderCardItemState._trigger == TriggerDirection.down) {
      var beginY =
          _TinderCardItemState._trigger == TriggerDirection.up ? -10 : 10;
